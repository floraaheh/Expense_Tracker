...
//                label = { Text("Describe expense (e.g. Coffee for $5)") },
...
//                modifier = Modifier.fillMaxWidth()
//            )
//            // You would add a dropdown for category here
//
//            Button(onClick = ::handleAddTransaction, modifier = Modifier.fillMaxWidth()) {
